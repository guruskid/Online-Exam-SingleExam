	...
	<div class="loginboxinner radius">
        ...
        <div class="loginform">
			...
			<tr><td style="padding-left:50px;">
                 <p style="font-size:14px;" class="title">University ID</p></td><td>&nbsp;</td><td> <input type="text" placeholder="ex: N130950" id="uid1"  value="" class="radius mini" />
            </td></tr>
			<tr><td style="padding-left:50px;">
                 <p style="font-size:14px;" class="title">University ID</p></td><td>&nbsp;</td><td> <input type="text" placeholder="ex: N130950" id="uid2"  value="" class="radius mini" />
            </td></tr>
			<tr><td style="padding-left:50px;">
                 <p style="font-size:14px;" class="title">University ID</p></td><td>&nbsp;</td><td> <input type="text" placeholder="ex: N130950" id="uid3"  value="" class="radius mini" />
            </td></tr>
        <tr><td>&nbsp;</td><td colspan="3"><p>
                	<a class="button" class="radius title" onclick="teamreg()" name="client_login" style="width:180px;padding:7px;">Register</a>
                	<br><br><a  href="index.php" name="client_login" style="width:180px;padding:7px;">Login</a>
                </p>
                </td></tr>
